        ...
        <div class="modal">
            ...
            <slot name="footer">
                <div class="modal-footer">
                    ...
                    <button class="modal-footer__button" @click="reject_student">
                        Отправить
                    </button>
                </div>
            </slot>
        ...
        methods: {
            ...
            async reject_application() {
                try {
                    ...
                    const response = await json_fetch('http://localhost:3000/rejectapplication', {
                        status: "отклонен", _id: application_id, employer_answer         
                    }) 
